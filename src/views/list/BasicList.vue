...
const allData = ref<ListItem[]>([
  ...
  { id: 4, title: 'vue-admin', avatar: 'https://api.dicebear.com/7.x/shapes/svg?seed=l4&backgroundColor=42b883', description: '城镇中有那么多的酒馆，她却偏偏走进了我的酒馆', owner: '周星星', startAt: '2024-08-12 22:44', progress: 30, status: 'processing' },
